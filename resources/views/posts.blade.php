            ...
            <form>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="記事を検索" type="search" id="search" name="search" autocomplete="off">
                    </div>
                    <div>
        ...
        <div class="my-4 py-4 px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-0">
            ...
            @forelse($posts as $post)
                {{-- <article class="py-8 max-w-screen-md border-b border-gray-300">
                    ...
                    <a href="/posts/{{ $post['slug'] }}" class="font-medium text-blue-500 hover:underline">続きを読む &raquo;</a>
                </article>   --}}
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <a href="/posts?category={{ $post->category->slug }}">
                            <span class="bg-{{ $post->category->color }}-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800 lg:max-w-60 md:max-w-48">
                                {{ $post->category->name }}
                            </span>
                        </a>
                ...
                @empty
                <div>
                    <p class="font-semibold text-xl my-4 justify-center">記事見つかれませんでした！</p>
                    <p class="font-semibold text-sm my-4 justify-center">検索場所を確認して、ブログページでもう一回検索してみてください。</p>
                    <a href="/posts" class="block text-blue-500 hover:underline">&laquo; ブログに戻り</a>
                </div>
            @endforelse
